...
import Icon_Calendar from '../Assets/Image/MainPage/icon_calendar.png';
import Icon_Community from '../Assets/Image/MainPage/icon_communication.png';
import Icon_Notice from '../Assets/Image/MainPage/icon_notice.png';
...
export const IMAGE = {
  ...
  BeaconIcon: Icon_Beacon,
  AttendanceIcon: Icon_Attendance,
  CalendarIcon: Icon_Calendar,
  CommunityIcon: Icon_Community,
  NoticeIcon: Icon_Notice,
};
